...
const styles = StyleSheet.create({
  ...
  headerSubtitle: { color: colors.white, fontSize: 16, marginTop: 5 },
  card: { 
  ...
  dishName: { fontSize: 18, fontWeight: 'bold', color: colors.text, marginBottom: 5 },
  description: { color: colors.text, marginBottom: 8, lineHeight: 20, fontSize: 14 },
    ...
    const samples: Omit<MenuItem, 'id'>[] = [
      {
        ...
        description: 'Succulent catfish fillets smothered in a rich, savory Cajun roux with onions, peppers, and celery, slow-simmered in Creole spice, and served over fluffy white rice. A Louisiana classic bursting with bold Southern flavors.',
        course: 'Mains',
        price: 399,
      },
      {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={{ flex: 1 }}>
        {menuItems.length === 0 ? (
          <View style={styles.card}>
            <Text style={{ textAlign: 'center', color: colors.text, fontSize: 16 }}>
      ...
      <View style={styles.buttonRow}>
        <TouchableOpacity style={[styles.button, styles.halfButton]} onPress={() => navigation.navigate('Add')}>
          <Text style={styles.buttonText}>Add New Dish</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.button, styles.halfButton, styles.buttonSecondary]} onPress={addSampleItems}>
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={{ padding: 10 }}>
        ...
        <Text style={{ fontSize: 16, fontWeight: '600', marginBottom: 8, color: colors.text }}>Select Course:</Text>
          ...
          {(['Starters', 'Mains', 'Desserts'] as Course[]).map((crse) => (
            <TouchableOpacity 
              ...
              style={{
                ...
                backgroundColor: course === crse ? colors.primary : colors.white,
                alignItems: 'center',
              }}
    ...
    <NavigationContainer>
      ...
      >
        <Stack.Screen name="Home" options={{ title: 'Dine Smart - Menu' }}>
          {(props) => <HomeScreen {...props} menuItems={menuItems} onAddMenuItem={addMenuItem} />}
        </Stack.Screen>
